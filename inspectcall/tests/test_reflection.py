from ..reflection import get_signature, get_callargs
...
# Test suite for get_callargs ------------------------------------------

def test_get_callargs_empty_call():
    def f(): pass
    args = []
    kwargs = {}
    expected = {}
    actual = get_callargs(f, *args, **kwargs)
    assert actual == expected


def test_get_callargs_all_positional():
    def f(x, y): pass
    args = [1, 2]
    kwargs = {}
    expected = {'x': 1, 'y': 2}
...
def test_get_callargs_all_kwargs():
    def f(x, y): pass
    args = []
    kwargs = {'x': 1, 'y': 2}
    expected = {'x': 1, 'y': 2}
...
def test_get_callargs_missing_args():
    def f(x, y, z): pass
    args = [1]
    kwargs = {'z': 3}
...
def test_get_callargs_empty_varargs():
    def f(x, *fargs): pass
    args = []
    kwargs = {}
...
def test_get_callargs_nonempty_varargs():
    def f(x, *fargs): pass
    args = [1, 2, 3]
    kwargs = {}
...
def test_get_callargs_empty_vkwargs():
...
def test_get_callargs_nonempty_vkwargs():
    def f(x, **fkwargs): pass
    args = [1]
    kwargs = {'y': 3, 'z': 4}
...
def test_get_callargs_all_defaulted_args():
    def f(x=1, y=2): pass
    args = []
    kwargs = {}
    expected = {'x': 1, 'y': 2}
...
def test_get_callargs_some_defaulted_args_some_pos():
    def f(x=1, y=2): pass
    args = [4]
    kwargs = {}
    expected = {'x': 4, 'y': 2}
...
def test_get_callargs_some_defaulted_args_some_kwargs():
    def f(x=1, y=2): pass
    args = []
    kwargs = {'y': 4}
    expected = {'x': 1, 'y': 4}
...
def test_get_callargs_extra_pos_args():
    """
...
def test_get_callargs_extra_kwargs():
    """
...
def test_get_callargs_kitchen_sink_novarargs_legal():
    """
...
def test_get_callargs_kitchen_sink_varargs_legal():
    """
